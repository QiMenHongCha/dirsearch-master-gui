...
3. 在"字典设置"标签页中配置词典文件和扩展名(不选有默认配置)
...
理论上来说只要替换掉dirsearch-master文件夹就可

## 版权信息

原始  dirsearch 工具由 Mauro Soria 开发。此 GUI 界面为第三方开发，基于原工具构建。https://github.com/maurosoria/dirsearch
